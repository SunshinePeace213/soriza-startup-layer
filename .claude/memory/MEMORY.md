...
- [skill-listing budget](skill-listing-budget.md) — skill descriptions: per-entry 1,536-char cap + global ~1% budget (drops least-used); the layer's de-dup standard (description=triggers, when_to_use=gate+boundaries only) + factory enforcement in prompt-architect/nuwa; fixed to ~0.6% on 2026-06-06
